            ...
            >
              <div className="gradient-primary rounded-2xl p-6 text-primary-foreground">
                ...
                <p className="text-sm opacity-90 mt-2">
                  To be the leading healthcare employer known for nurturing talent
              ...
              <div className="gradient-cool rounded-2xl p-6 text-primary-foreground">
                ...
                <p className="text-sm opacity-90 mt-2">
                  Integrity, compassion, innovation, teamwork, and continuous improvement.
                </p>
              </div>
              <div className="gradient-warm rounded-2xl p-6 text-primary-foreground col-span-2">
                ...
                <p className="text-sm opacity-90 mt-2">
                  A collaborative workplace that celebrates diversity, encourages growth,
                  and ensures every team member feels valued and empowered.
                </p>
              </div>
            </motion.div>
          </div>
              ...
              {jobs.map((job, i) => (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <span className="text-xs px-2.5 py-1 rounded-full font-medium bg-pipeline-hired/10 text-pipeline-hired">
                      Open
                    </span>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {(job.requirements || []).slice(0, 3).map(req => (
                      <span key={req} className="text-[11px] px-2 py-0.5 bg-muted rounded-md text-muted-foreground">
                        {req}
                      </span>
                    ))}
                  </div>
                  ...
                  <div className="space-y-2 text-xs text-muted-foreground mb-4">
                    ...
                    <div className="flex items-center gap-1.5">
                      <MapPin className="w-3.5 h-3.5" /> {job.location || 'On-site'}
                    </div>
                    <div className="flex items-center gap-1.5">
                    ...
                    {job.closing_date && (
                      <div className="flex items-center gap-1.5">
                        <Users className="w-3.5 h-3.5" /> Closes {job.closing_date}
                      </div>
                    )}
                  </div>
