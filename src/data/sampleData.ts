export type ApplicantStatus = 'Applied' | 'Under Screening' | 'Shortlisted' | 'Interview Scheduled' | 'Interview Completed' | 'Selected' | 'Offer Sent' | 'Offer Accepted' | 'Offer Declined' | 'Hired' | 'Rejected';
